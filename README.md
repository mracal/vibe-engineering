...
- Look for a file ending with `.exe` if available. This is an installer you can run directly.
- If there is a ZIP file, download it, and you will need to extract the contents.
...
- If you downloaded an `.exe` file, double-click it to start installation. Follow the on-screen prompts. You can keep the default options.
- If you downloaded a ZIP file, right-click it and choose **Extract All**. Pick a folder on your computer where you can find the files later.

### 5. Open vibe-engineering

Once installed or extracted, locate the program in your Start menu or folder and double-click it to open.

---

## ⚙️ How to Use vibe-engineering
...
## 🔄 Updating vibe-engineering

Check back on the GitHub releases page regularly. When a new version is available:

- Download the latest `.exe` or ZIP file.
- Follow the same installation or extraction steps.
